...
document
    ...
    .addEventListener("click", function cendroidsIsOn() {
        ...
        Swal.fire({
            icon: "info",
            title: "Find euclidean distance between centroid(C1) and data-points!",
            html: 'To compute click on the <b style="color: #FF6600">D1</b> button.',
            customClass: {
                container: "swal-container",
                popup: "swal-popup",
                title: "swal-title",
...
document.getElementById("c1compute").addEventListener("click", function () {
    ...
    setTimeout(function () {
        ...
        Swal.fire({
            icon: "info",
            title: "Find euclidean distance between centroid(C2) and data-points!",
            html: 'To compute click on the <b style="color: #FF6600">D2</b> button.',
            customClass: {
                container: "swal-container",
                popup: "swal-popup",
                title: "swal-title",
...
document.getElementById("c2compute").addEventListener("click", function () {
    ...
    if (kVal > 2) {
        setTimeout(function () {
            ...
            Swal.fire({
                icon: "info",
                title: "Find euclidean distance between centroid(C3) and data-points!",
                html: 'To compute click on <b style="color: #FF6600">D3</b> button.',
                customClass: {
                    container: "swal-container",
                    popup: "swal-popup",
                    title: "swal-title",
...
document.getElementById("c3compute").addEventListener("click", function () {
    ...
    if (kVal > 3) {
        setTimeout(function () {
            ...
            Swal.fire({
                icon: "info",
                title: "Find euclidean distance between centroid(C4) and data-points!",
                html: 'To compute click on <b style="color: #FF6600">D4</b> button.',
                customClass: {
                    container: "swal-container",
                    popup: "swal-popup",
                    title: "swal-title",
...
function editCell(cell) {
    ...
    const [PopUpTitle, Hint] = updateTitle(currentCellIndex);
    ...
    Swal.fire({
        ...
        html: `Position of ${PopUpTitle}<br>Hint: ${Hint}`,
        input: "number",
        ...
        if (result.isConfirmed) {
            ...
            // If duplicate values are found, show an alert
                ...
                Swal.fire({
                    title: "Incorrect value!",
                    text: ` Follow step 7 of the INSTRUCTIONS.`,
                    icon: "error",
                    customClass: {
                        container: "swal-container",
                        popup: "swal-popup",
...
function updateTitle(i) {
    ...
    if(kVal==2)
    {
        const d1 = parseFloat(dataRows[i].cells[3].textContent);
        const d2 = parseFloat(dataRows[i].cells[4].textContent);
        title='MIN('+d1+', '+d2+')'
        if(d1<d2)
        {
            posHint=1
    ...
    if(kVal==3)
    {
        const d1 = parseFloat(dataRows[i].cells[3].textContent);
        const d2 = parseFloat(dataRows[i].cells[4].textContent);
        const d3 = parseFloat(dataRows[i].cells[5].textContent);
        title='MIN('+d1+', '+d2+', '+d3+')'
        if(d1<d2 && d1<d3)
        {
            posHint=1
    ...
    //     const d2 = parseFloat(dataRows[i].cells[4].textContent);
    //     const d3 = parseFloat(dataRows[i].cells[5].textContent);
    //     const d4 = parseFloat(dataRows[i].cells[6].textContent);
    //     title='MIN('+d1+', '+d2+', '+d3+', '+d4+')'
    // }
   

        return [title, posHint];
}
    ...
    if (currentCluster > (kVal + 1)) {
        ...
        if (alertCount < 2) {
            ...
            Swal.fire({
                icon: "info",
                title: "Find euclidean distance between centroid(C1) and data-points!",
                html: 'To compute click on <b style="color: #FF6600">D1</b> button.',
                customClass: {
                    container: "swal-container",
                    popup: "swal-popup",
                    title: "swal-title",
...
function drawChartAnalysis() {
    var numPoints = 6; // Number of data points
